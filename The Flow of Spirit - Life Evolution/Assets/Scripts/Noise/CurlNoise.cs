...
public class CurlNoise 
{
	...
	private const int gradientsMask = 15;
	private const int hashMask = 255;

	public static NoiseSample PerlinNoise (Vector3 point, float frequency) 
	{
		point *= frequency;
		...
		int h01 = hash[h0 + iy1];
		int h11 = hash[h1 + iy1];
		Vector3 g000 = gradients[hash[h00 + iz0] & gradientsMask];
		Vector3 g100 = gradients[hash[h10 + iz0] & gradientsMask];
		Vector3 g010 = gradients[hash[h01 + iz0] & gradientsMask];
		Vector3 g110 = gradients[hash[h11 + iz0] & gradientsMask];
		Vector3 g001 = gradients[hash[h00 + iz1] & gradientsMask];
		Vector3 g101 = gradients[hash[h10 + iz1] & gradientsMask];
		Vector3 g011 = gradients[hash[h01 + iz1] & gradientsMask];
		Vector3 g111 = gradients[hash[h11 + iz1] & gradientsMask];
