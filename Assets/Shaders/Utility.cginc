...
{
	return lerp(_Color1, _Color2, 1 - time01);
}

float calc_alpha(float2 uv, float time01, float t1, float t2)
{
	if(time01>t2)
		return lerp(1, 0, (time01 - t2)/(1-t2));
	if(time01<t1)
		return lerp(1, 0, (t1 - time01)/t1);
